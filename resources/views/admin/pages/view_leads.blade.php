...
@section("content")
                ...
                <div class="content">
                      ...
                      <ul class="dash-btn">
                            ...
                            <li><a class="{{classActivePath('adduser')}}" href="{{ URL::to('admin/leads/addnew') }}" >Add New </a></li>
                          
                            <li class="active"><a  href="{{ URL::to('admin/leads') }}" >All leads</a></li>
                            </ul>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        ...
                        <div class="block-content">
							...
							{!! Form::open(array('url' => array('admin/leads'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                                <tr>
                                    <td>
                                ...
                                <tbody>
									...
									<td>{{ $i+1}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ url('admin/leads/addnew/'.$leads->id) }}" class="btn btn-xs btn-default"  data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>

                                                 <a href="{{ url('admin/leads/delete/'.$leads->id) }}" class="btn btn-xs btn-default"  data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure? You will not be able to recover this.')"><i class="fa fa-times"></i></a>
                                            </div>
