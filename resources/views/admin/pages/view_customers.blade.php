...
@section("content")
                ...
                <div class="content">
                      ...
                      <ul class="dash-btn">
                            ...
                            <li class="active"><a  href="{{ URL::to('admin/customers') }}" >All Customers</a></li>
                            </ul>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        ...
                        <div class="block-content">
							...
							{!! Form::open(array('url' => array('admin/customers'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                                <tr>
                                    <td>
