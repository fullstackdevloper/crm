...
<div class="content content-boxed">
       <h1 class="user-head">
                        ...
                        <ul class="dash-btn">
                            ...
                            <li class="active"><a  href="{{ URL::to('manager/leads/addnew') }}" >Add New</a></li>
                          
                            <li ><a class="{{classActivePath('adduser')}}" href="{{ URL::to('manager/leads') }}" >All leads</a></li>
                            </ul>
    <div class="row" >
        <div class="col-sm-12 col-lg-12" >
		 <div class="block">
                ...
                <div class="block-content tab-content"> 
                    ...
                    {!! Form::open(array('url' => array('manager/leads/addnew'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
								...
								<div class="col-sm-6 col-lg-6" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               ...
                                               <select name="assigned"  class="form-control " >
													...
													@foreach(\App\User::where('status',1)->where('usertype','manager')->orwhere('usertype','Bidder')->get() as $assigned)
										...
										<div class="form-group">
                                            <label class="control-label col-md-3">
                                                 Skype</label>
                                            <div class="col-md-9">
                                                <input name="skype"  class="form-control " value="{{ isset($leads->skype) ? $leads->skype : null }}" type="text" >
                                            </div>
                                        </div>
                                        </div>
                                  <div class="col-sm-6 col-lg-6" >
				...
				{!! Form::open(array('url' => array('manager/leads/addnote'),'class'=>'form-horizontal padding-15','name'=>'for_note','id'=>'for_note','role'=>'form','enctype' => 'multipart/form-data')) !!}
				...
				<div class="btn-group">
               <a href="{{ url('manager/notes/delete/'.$note->id) }}" class=""  data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure? You will not be able to recover this.')">Remove</a>
                 </div>
                </div>
				@endforeach
				@endif
