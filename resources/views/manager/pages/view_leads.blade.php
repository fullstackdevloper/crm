...
@section("content")
                ...
                <div class="content">
                      ...
                      <ul class="dash-btn">
                            ...
                            <li><a class="{{classActivePath('adduser')}}" href="{{ URL::to('manager/leads/addnew') }}" >Add New </a></li>
                          
                            <li class="active"><a  href="{{ URL::to('manager/leads') }}" >All leads</a></li>
                            </ul>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                        ...
                        <div class="block-content">
							...
							{!! Form::open(array('url' => array('manager/leads'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                                <tr>
                                    <td>
