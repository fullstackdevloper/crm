                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidingbbr sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
							...
							<a class="h5 text-white" href="{{ URL::to('manager/dashboard') }}">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li class="hov-cl">
                                    <a class="{{classActivePath('dashboard')}}" href="{{ URL::to('manager/dashboard') }}">
								 ...
								 <li class="hov-cl">
                                    <a class="{{classActivePath('dashboard')}}" href="{{ URL::to('manager/customers') }}">
								 ...
								 <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									  <li><a class="{{classActivePath('adduser')}}" href="{{ URL::to('manager/leads/addnew') }}" ><i class="fa fa-list-alt"></i>Add New</a></li>
										<li><a  href="{{ URL::to('manager/leads') }}" ><i class="fa fa-list-alt"></i>All  Leads</a></li>
								  ...
								  <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									  <li><a class="{{classActivePath('adduser')}}" href="{{ URL::to('manager/upbms/addnew') }}" ><i class="fa fa-list"></i>Add New</a></li>
										<li><a  href="{{ URL::to('manager/upbms') }}" ><i class="fa fa-list"></i>All  Upbm</a></li>
								...
								<li class="hov-cl">
                                     <a class="{{classActivePath('logout')}}" href="{{ URL::to('manager/logout') }}">
