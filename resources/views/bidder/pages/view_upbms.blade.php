                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
							...
							{!! Form::open(array('url' => array('bidder/upbms'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                                <tr>
                                    <td>
                                ...
                                <tbody>
									...
									<td>{{ $i+1}}</td>
										...
										<td class="font-w600"> 
                                            ...
                                            <a href="{{URL::to('bidder/upbms/status/'.$upbms->id.'/Lead')}}" data-toggle="tooltip" title="Lead"  class="text-danger">Bid Placed </a>
                                            @else
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ url('bidder/upbms/addnew/'.$upbms->id) }}" class="btn btn-xs btn-default"  data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>

                                                 <a href="{{ url('bidder/upbms/delete/'.$upbms->id) }}" class="btn btn-xs btn-default"  data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure? You will not be able to recover this.')"><i class="fa fa-times"></i></a>
                                            </div>
