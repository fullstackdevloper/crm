...
@section("content")
 ...
 <!-- Page Header -->
                <div class="content bg-image" style="background-image: url('{{ URL::asset('bidder_assets/img/photos/bg.jpg') }}');">
                    <div class="push-50-t push-15 clearfix">
                        <div class="push-15-r pull-left animated fadeIn">
                            ...
                            <img src="{{ URL::asset('bidder_assets/img/avatars/avatar10.jpg') }}" alt="Avatar"  class="img-avatar img-avatar-thumb"/>
                                ...
                                <div class="block-content tab-content">
                                 ...
                                 @if(Session::has('flash_message'))
                                    ...
                                    @endif
                                        ...
                                        {!! Form::open(array('url' => 'bidder/profile','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        ...
                                                        @else
                                                            ...
                                                            <img src="{{ URL::asset('bidder_assets/images/guy.jpg') }}" alt="person" class="img-circle" width="80"/>
                                    ...
                                    <div class="col-lg-8 tab-pane" id="btabs-alt-static-password">
                                       {!! Form::open(array('url' => 'bidder/profile_pass','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
