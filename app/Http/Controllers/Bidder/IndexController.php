...
class IndexController extends MainBidderController
{
    ...
    public function postLogin(Request $request)
    {
      ...
      $this->validate($request, [
        ...
        $credentials = $request->only('email', 'password');
         ...
         if (Auth::attempt($credentials, $request->has('remember'))) {
            ...
            if(Auth::user()->usertype !='Bidder'){
                \Auth::logout();
				 return redirect('/bidder')->withErrors('No Permission.');
            }
       ...
       return redirect('/bidder')->withErrors('The email or the password is invalid. Please try again.');
