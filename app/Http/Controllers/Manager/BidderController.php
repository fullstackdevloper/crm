...
class BidderController extends MainManagerController
{
    ...
    public function add_bidder(Request $request)
    {
        ...
        return view('manager.pages.add_edit_bidder');
    }
    ...
    public function edit_bidder(Request $request)
    {
        ...
        return view('manager.pages.add_edit_bidder', compact('bidders'));
    }
    ...
    public function allbidder(Request $request)
    {
        ...
        return view('manager.pages.view_bidders', compact('allUser'));
    }
