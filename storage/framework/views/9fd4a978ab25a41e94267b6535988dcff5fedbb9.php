            ...
            <div class="row">
				...
				<?php endif; ?>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <?php echo Form::open(array('url' => 'company/login','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'loginform','role'=>'form')); ?>
                            ...
                            <?php echo Form::close(); ?> 
                            <!-- END Login Form -->
							<a class="btn btn-block" href="<?php echo e(URL::to('company/sign-up')); ?>" type="button">Sign Up</a>
                        </div>
                    </div>
                    <!-- END Login Block -->
                </div>
