 ...
 <!-- Page Header -->
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo e(URL::asset('admin_assets/img/photos/bg.jpg')); ?>');">
                    <div class="push-50-t push-15">
                        ...
                        <h2 class="h5 text-white-op animated zoomIn">Welcome Management</h2>
                    </div>
                </div>
                <!-- END Page Header -->
...
<?php echo $__env->make("management.app", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>