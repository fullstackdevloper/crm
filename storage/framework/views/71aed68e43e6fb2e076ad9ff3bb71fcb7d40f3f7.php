...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title><?php echo e(getcong('site_name')); ?> <</title>      
...
<span aria-hidden="true">&times;</span></button>
                        ...
                        <?php endif; ?>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <?php echo Form::open(array('url' => 'password/reset','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'passwordform','role'=>'form')); ?>
            ...
            <div class="form-group">
              <button id="submit" name="submit" class="btn btn-block btn-primary"> <i class="si si-envelope-open pull-right"></i>Reset Password</button>
                            <?php echo Form::close(); ?> 
                            <!-- END Login Form -->
                        </div>
                    </div>
