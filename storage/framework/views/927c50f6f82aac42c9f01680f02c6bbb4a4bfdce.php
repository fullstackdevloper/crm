                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li class="hov-cl">
								  ...
								  <li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('dashboard')); ?>" href="<?php echo e(URL::to('admin/customers')); ?>">
								  ...
								  <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									  <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/leads/addnew')); ?>" ><i class="fa fa-list-alt"></i>Add New</a></li>
										<li><a  href="<?php echo e(URL::to('admin/leads')); ?>" ><i class="fa fa-list-alt"></i>All  Leads</a></li>
								...
								<li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									 <li><a  href="<?php echo e(URL::to('admin/upbms/addnew')); ?>" ><i class="fa fa-list"></i>Add New</a></li>
										<li><a  href="<?php echo e(URL::to('admin/upbms')); ?>" ><i class="fa fa-list"></i>All UPBM</a></li>
								 ...
								 <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									  ...
									  <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/profile')); ?>" ><i class="fa fa-user-md"></i>Profile</a></li>
									  <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/upworks')); ?>" ><i class="fa fa-underline"></i>Upworks</a></li>
									   <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/managers')); ?>" ><i class="fa fa-user"></i>Manage Managers</a></li>
										<li><a  href="<?php echo e(URL::to('admin/bidders')); ?>" ><i class="fa fa-male"></i>Manage BDE</a></li>
										<li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/employees')); ?>" ><i class="fa fa-users"></i>All Employees</a></li>
