...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body style="background:url(<?php echo e(URL::asset('upload/mcloud-awards.jpg')); ?>) no-repeat">
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated fadeIn">
                        <div class="block-header bg-primary">
                            ...
                            <h3 class="block-title"> Parents Login</h3>
                        </div>
                ...
                <span aria-hidden="true">&times;</span></button>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <?php echo Form::open(array('url' => 'parents/login','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'loginform','role'=>'form')); ?>
        ...
        <!-- Page JS Plugins -->
        <script src="<?php echo e(URL::asset('parents_assets/js/plugins/jquery-validation/jquery.validate.min.js')); ?>"></script>
