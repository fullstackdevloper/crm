<?php $__env->startSection("content"); ?>
                ...
                <div class="content">
                      ...
                      <ul class="dash-btn">
                            ...
                            <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/leads/addnew')); ?>" >Add New </a></li>
                          
                            <li class="active"><a  href="<?php echo e(URL::to('admin/leads')); ?>" >All leads</a></li>
                            </ul>
                    <!-- Dynamic Table Full -->
                    <div class="block">
