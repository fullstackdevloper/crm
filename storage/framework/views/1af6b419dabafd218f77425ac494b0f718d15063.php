...
<div class="content content-boxed">
       <h1 class="user-head">
                        ...
                        <ul class="dash-btn">
                            ...
                            <li class="active"><a  href="<?php echo e(URL::to('manager/bidders/addnew')); ?>" >Add New</a></li>
                          
                            <li ><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('manager/bidders')); ?>" >All bidders</a></li>
                            </ul>
    <div class="row" >
        <div class="col-sm-12 col-lg-12" >
            <div class="block">
                <div class="block-content block-content-narrow"> 
                    ...
                    <?php echo Form::open(array('url' => array('manager/bidders/addnew'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')); ?> 
