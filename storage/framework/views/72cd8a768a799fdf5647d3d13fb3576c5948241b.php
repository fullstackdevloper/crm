...
<div class="content content-boxed">
       <h1 class="user-head">
                        ...
                        <ul class="dash-btn">
                            ...
                            <li class="active"><a  href="<?php echo e(URL::to('admin/leads/addnew')); ?>" >Add New</a></li>
                          
                            <li ><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('admin/leads')); ?>" >All leads</a></li>
                            </ul>
    <div class="row" >
        <div class="col-sm-12 col-lg-12" >
		 <div class="block">
                ...
                <div class="block-content tab-content"> 
                    ...
                    <?php echo Form::open(array('url' => array('admin/leads/addnew'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')); ?> 
								...
								<div class="col-sm-6 col-lg-6" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               ...
                                               <select name="assigned"  class="form-control " >
													...
													<?php foreach(\App\User::where('status',1)->where('usertype','admin')->orwhere('usertype','Bidder')->get() as $assigned): ?>
										...
										<div class="form-group">
                                            <label class="control-label col-md-3">
                                                 Skype</label>
                                            <div class="col-md-9">
                                                <input name="skype"  class="form-control " value="<?php echo e(isset($leads->skype) ? $leads->skype : null); ?>" type="text" required="required" >
                                            </div>
                                        </div>
                                        </div>
                                  <div class="col-sm-6 col-lg-6" >
				...
				<?php echo Form::open(array('url' => array('admin/leads/addnote'),'class'=>'form-horizontal padding-15','name'=>'for_note','id'=>'for_note','role'=>'form','enctype' => 'multipart/form-data')); ?>
				...
				<div class="btn-group">
               <a href="<?php echo e(url('admin/notes/delete/'.$note->id)); ?>" class=""  data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure? You will not be able to recover this.')">Remove</a>
                 </div>
                </div>
				<?php endforeach; ?>
				<?php endif; ?>
