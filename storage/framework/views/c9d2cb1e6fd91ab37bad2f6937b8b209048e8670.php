 ...
 <!-- Page Header -->
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo e(URL::asset('admin_assets/img/photos/bg.jpg')); ?>');">
                    <div class="push-50-t push-15">
                        ...
                        <h2 class="h5 text-white-op animated zoomIn">Welcome Staff</h2>
                    </div>
                </div>
                <!-- END Page Header -->
                ...
                <div class="content content-narrow" >
                   <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3 detail-view-part">
                            <a class="block block-link-hover1 text-center fur-cls" href="<?php echo e(URL::to('staff/dashboard')); ?>">
...
<?php echo $__env->make("staff.app", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>