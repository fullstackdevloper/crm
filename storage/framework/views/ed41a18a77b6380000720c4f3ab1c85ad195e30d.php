...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
		...
		<!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/slick/slick.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/slick/slick-theme.min.css')); ?>">
		
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/datatables/jquery.dataTables.min.css')); ?>">
		
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/bootstrap-datepicker/bootstrap-datepicker3.min.css')); ?>">       
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/select2/select2.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/select2/select2-bootstrap.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/dropzonejs/dropzone.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/jquery-tags-input/jquery.tagsinput.min.css')); ?>">
		
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/summernote/summernote.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::asset('manager_assets/js/plugins/summernote/summernote-bs3.min.css')); ?>">
    ...
    <body>
     	...
     	<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <!-- Header -->
			<?php echo $__env->make("manager.topbar", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <!-- END Header -->
        ...
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/slick/slick.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/chartjs/Chart.min.js')); ?>"></script>
		
		
        <?php endif; ?>
        <!-- Page JS Code -->
        <?php if(classActivePath('dashboard')): ?>
		<script src="<?php echo e(URL::asset('manager_assets/js/pages/base_pages_dashboard.js')); ?>"></script>
        <?php endif; ?>
		
        
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/datatables/jquery.dataTables.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('manager_assets/js/pages/base_tables_datatables.js')); ?>"></script>
        
		
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/bootstrap-datepicker/bootstrap-datepicker.min.js')); ?>"></script>  
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/select2/select2.full.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/masked-inputs/jquery.maskedinput.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/dropzonejs/dropzone.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('manager_assets/js/plugins/jquery-tags-input/jquery.tagsinput.min.js')); ?>"></script>
		<script src="<?php echo e(URL::asset('manager_assets/js/plugins/summernote/summernote.min.js')); ?>"></script>
