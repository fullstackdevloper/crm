                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidingbbr sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="<?php echo e(URL::to('management/dashboard')); ?>">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('dashboard')); ?>" href="<?php echo e(URL::to('management/dashboard')); ?>">
								...
								<li class="hov-cl">
                                     <a class="<?php echo e(classActivePath('logout')); ?>" href="<?php echo e(URL::to('management/logout')); ?>">
