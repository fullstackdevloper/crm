            ...
            <div class="row">
                ...
                <span aria-hidden="true">&times;</span></button>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <?php echo Form::open(array('url' => 'broker/register','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'loginform','role'=>'form')); ?>
                            ...
                            <?php echo Form::close(); ?> 
                            <!-- END Login Form -->
							<a class="btn btn-block" href="<?php echo e(URL::to('broker')); ?>" type="button">Login</a>
                        </div>
                    </div>
                    <!-- END Login Block -->
                </div>
