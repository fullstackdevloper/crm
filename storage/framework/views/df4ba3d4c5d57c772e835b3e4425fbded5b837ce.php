<?php $__env->startSection("content"); ?>
 <!-- Page Header -->
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo e(URL::asset('parents_assets/img/photos/bg.jpg')); ?>');">
                ...
                <div class="content content-narrow" >
                   <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3 detail-view-part">
                            <a class="block block-link-hover1 text-center fur-cls" href="<?php echo e(URL::to('parents/dashboard')); ?>">
...
<?php echo $__env->make("parents.app", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>