<?php $__env->startSection("content"); ?>
 <!-- Page Header -->
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('<?php echo e(URL::asset('manager_assets/img/photos/bg.jpg')); ?>');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">Dashboard</h1>
                        <h2 class="h5 text-white-op animated zoomIn">Welcome Manager</h2>
                    </div>
                </div>
                <!-- END Page Header -->
                ...
                <div class="content content-narrow" >
                   <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3 detail-view-part">
                            <a class="block block-link-hover1 text-center fur-cls" href="<?php echo e(URL::to('manager/dashboard')); ?>">
