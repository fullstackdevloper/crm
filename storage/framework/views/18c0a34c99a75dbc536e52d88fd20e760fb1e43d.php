                    ...
                    <div class="sidingbbr sidebar-content">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
								...
								<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('dashboard')); ?>" href="<?php echo e(URL::to('bidder/profile')); ?>">
                                        <span class="side-add"><i class="fa fa-user-md"></i>
                                        </span>
                                        <span class="sidebar-mini-hide side-add2">Profile</span></a>
                                </li>
								<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('dashboard')); ?>" href="<?php echo e(URL::to('bidder/leads')); ?>">
								 ...
								 <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
									  <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('bidder/upbms/addnew')); ?>" ><i class="fa fa-list"></i>Add New</a></li>
										<li><a  href="<?php echo e(URL::to('bidder/upbms')); ?>" ><i class="fa fa-list"></i>All  Upbm</a></li>
