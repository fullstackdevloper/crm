                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidingbbr sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="<?php echo e(URL::to('broker/dashboard')); ?>">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
								...
								<li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('profile')); ?>" href="<?php echo e(URL::to('#')); ?>">
                                 ...
                                 <li class="hov-cl">
                                     ...
                                     <ul class="sub-menu-de">
                                         <li><a class="<?php echo e(classActivePath('adduser')); ?>" href="<?php echo e(URL::to('#')); ?>" ><i class="fa fa-users"></i>Add Leads</a></li>
                                         <li><a  href="<?php echo e(URL::to('#')); ?>" ><i class="fa fa-users"></i>View Leads</a></li>
                                         
                                     </ul>
                                 </li>
								 <li class="hov-cl">
                                    <a class="<?php echo e(classActivePath('logout')); ?>" href="<?php echo e(URL::to('broker/logout')); ?>">
